...
def ml_pipeline():
    ...
    train_dataset, val_dataset, test_dataset = datasets(X_train, X_val, X_test, y_train, y_val, y_test)

    # Model training Step
    model_trained = train(train_dataset, val_dataset, NUM_LABELS, id2label, label2id)
