...
from pipelines.preproc4colab import local_pipeline
...
def colab_pipeline2()-> Annotated[BertForSequenceClassification, "model_bert"]:
    """Pipeline that imports artifacts and runs training in Colab."""
    
    # Import artifacts from the local pipeline run
    train_dataset, val_dataset, NUM_LABELS, id2label, label2id, weights = local_pipeline()
